...
import TextFieldsOutlined from '@mui/icons-material/Article';
            ...
            >
                ...
                >
                    ...
                    <Grid container spacing={4} data-aos='fade-up'>
                        ...
                        />
                        <DescriptionItem 
                            icon={<TextFieldsOutlined style={{ height: 25, width: 25 }} />}
                            title='Write a list of labels'
                            subtitle='Write down a list of possible labels.'
                        />
                        <DescriptionItem 
                        ...
                        <DescriptionItem 
                            ...
                            subtitle='Next, CLIP will select the most likely label, and the result of the classification is then printed on the screen.'
                        />
                    </Grid>
                </Container>
            </Box>
